...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<div class="container-fluid">
  		<div class="profile-card" style="max-width: 450px; margin: auto; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); padding: 16px; text-align: center; background-color: #ccffcc;">
    		<img src="assets/img/img_profiles/profile.jpg" alt="Deskripsi foto" style="width: 80%; height: auto; border-radius: 50%;" />
    		<h3 style="color: #333;"><?= $dataUser['nama_lengkap']; ?></h3>
    		<p class="title" style="color: black; font-size: 18px;"><?= $dataUser['nama_jabatan']; ?></p>
