      ...
      <div class="container-fluid">
        <div class="row">
          <?php if ($_SESSION['id_jabatan'] == '1'): ?>
            <div class="col-lg-4">
              <div class="card shadow" style="background-color: #abdee6">
                <div class="card-body">
            ...
            <div class="col-lg-4">
              <div class="card shadow" style="background-color: #cbaacb">
                <div class="card-body">
          ...
          <?php endif ?>
          <div class="col-lg-4">
            <div class="card shadow" style="background-color: #ffffb5">
              <div class="card-body">
          ...
          <div class="col-lg-4">
            <div class="card shadow" style="background-color: #ffccb6">
              <div class="card-body">
          ...
          <div class="col-lg-4">
            <div class="card shadow" style="background-color: #ccccff">
              <div class="card-body">
