...
INSERT INTO `user` (`id_user`, `nama_lengkap`, `username`, `password`, `id_jabatan`, `user_foto`) VALUES
(1, 'Rindu Adam Sari Siregar', 'rindusiregar', '$2y$10$RtlG8gY2cp/2BYEeMBJ2C.tMli1qvWGCoT/jkKIZVNrRJ/4cGbbTm', 1, ''),
